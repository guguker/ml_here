...
`business_type` принимает один из 20 фиксированных профилей или его алиас на русском/английском. ПВЗ остается общей группой: `pickup_point`, а внутри профиля учитываются Ozon, Wildberries, Яндекс Маркет, СДЭК, Boxberry и похожие операторы.
...
- `nail_salon` — Маникюр / ногтевая студия
- `fitness_studio` — Фитнес / спорт-студия
...
- `dry_cleaning` — Химчистка / прачечная
- `children_education` — Детский центр / образование
- `retail` — Магазин у дома / розница
